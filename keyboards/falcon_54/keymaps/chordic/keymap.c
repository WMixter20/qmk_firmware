...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { 
    ...
    [_BASE] = LAYOUT_split_5x6(
        ...
        KC_CAPS,        KC_A,         KC_S,          KC_D,         KC_F,         KC_G,                                         KC_H,         KC_J,         KC_K,         KC_UP,        KC_L,      KC_MUTE,                              
                        KC_Z,         KC_X,          KC_C,         KC_V,         KC_B,        KC_ENC_TOG,                         KC_N,         KC_M,         KC_LEFT,     KC_DOWN,       KC_RIGHT,      
                                                     KC_LCTL,        KC_LALT,      KC_LCMD,      KC_SPC,            KC_BSPC,   KC_RCMD,       KC_ENT,       KC_DEL

    ),
        [_FN1] = LAYOUT_split_5x6(
        KC_TRNS,      KC_TRNS,      KC_TRNS,      KC_TRNS,      KC_TRNS,      TO(_BASE),                                   KC_TRNS,      KC_TRNS,      KC_TRNS,      KC_TRNS,      KC_TRNS,      KC_TRNS,                            
        ...
        KC_TRNS,      KC_TRNS,      KC_TRNS,      KC_TRNS,      KC_TRNS,      KC_TRNS,                                     KC_TRNS,      KC_P4,         KC_P5,         KC_P6,         KC_TRNS,      KC_TRNS,                              
                      KC_TRNS,      KC_TRNS,      KC_TRNS,      KC_TRNS,      KC_TRNS,      KC_TRNS,                       KC_P0,         KC_P7,         KC_P8,         KC_P9,         KC_TRNS,      
